...
public class EasyInfo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.easyinfo);
		settingsVarry();
		settingsButtonFun();
		showItems();
	}
	...
	private void settingsVarry() {
		mListView = (ListView) findViewById(R.id.easyinfoListView);
		mOpenHelper = new DBHelper(this);  
		mCursor = mOpenHelper.queryEasy();  
	}

	private void settingsButtonFun() {
		Button returnButton = (Button) findViewById(R.id.easyInfoReturnButton);
	...
	private void showItems() {
		...
		mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Log.e("mCursor.getString(4)", mCursor.getString(4));
				try {
					infoIntent = new Intent();
					infoBundle = new Bundle();
					Log.e("1", "1");
					infoIntent.setClass(EasyInfo.this, InfomationDetail.class);
					Log.e("2", "2");
